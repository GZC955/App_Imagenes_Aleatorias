...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    buttonDrawBitmap_1 = findViewById(R.id.buttonDrawBitmap_1) // Inicio del Boton 1
    imageViewBitmap_1 = findViewById(R.id.imageViewBitmap_1) // Inicio del espacio de imagen uno
    buttonDrawBitmap_1.setOnClickListener {    // Función para generar número aleatorio con el boton 1
    ...
    //Misma dinámica aplicada a cada uno de los botones restantes
